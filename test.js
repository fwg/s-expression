...
assert.deepEqual(SParse("`(a,b)"), ['quasiquote', ['a', ['unquote', 'b']]], 'Unquote should act symbol delimiting');
assert.deepEqual(SParse("`(a,@b)"), ['quasiquote', ['a', ['unquote-splicing', 'b']]], 'Unquote-splicing should act symbol delimiting');
